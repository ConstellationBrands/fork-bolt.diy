...
export default function ChatAlert({ alert, clearAlert, postMessage, autoFixState }: Props) {
  ...
  const message =
    isInfo && isPreview
      ? 'bolt.diy detected a preview problem and is automatically repairing it. The workspace will keep working until a previewable app is ready.'
        ...
        : autoFixState === 'queued'
          ...
          : isPreview
            ...
            : isBlockedShellMutation
              ? 'Bolt attempted to write project files through a shell command. That is blocked for safety. Bolt can retry the same change using file actions instead.'
